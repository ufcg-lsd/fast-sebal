...
int main(int argc, char *argv[]){
    ...
    //TIFFClose(ndvi);
    TIFF * ndvi = TIFFOpen("Testes/Teste04/NDVI.tif", "rm");
    ...
    setup(aerodynamic_resistence, ndvi);
