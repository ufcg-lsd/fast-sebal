...
struct Landsat{
    ...
    void open_tiffs(TIFF *albedo, TIFF *ndvi, TIFF *evi, TIFF *lai, TIFF *soil_heat, TIFF *surface_temperature, TIFF *net_radiation, TIFF* evapotranspiration_fraction, TIFF* evapotranspiration_24h);
