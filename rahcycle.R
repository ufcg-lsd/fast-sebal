...
ncvar_put(newEFNCDF4,"EF",oldEFValues,start=c(1,1,1),count=c(10,10, 1))
nc_close(newEFNCDF4)
...
ncvar_put(newET24hNCDF4, "ET24h", oldET24hValues, start=c(1, 1, 1), count=c(10, 10, 1))
...
ncvar_put(newzomNCDF4, "zom", oldzomValues, start=c(1, 1, 1), count=c(10, 10, 1))
...
ncvar_put(newustar_afterNCDF4, "ustar_after", oldustar_afterValues, start=c(1, 1, 1), count=c(10, 10, 1))
...
ncvar_put(newRah_afterNCDF4, "Rah_after", oldRah_afterValues, start=c(1, 1, 1), count=c(10, 10, 1))
...
ncvar_put(newHNCDF4, "H", oldHValues, start=c(1, 1, 1), count=c(10, 10, 1))
nc_close(newHNCDF4)
...
ncvar_put(newLatentHFNCDF4, "LatentHF", oldLatentHFValues, start=c(1, 1, 1), count=c(10, 10, 1))
...
ncvar_put(newRn24hNCDF4, "Rn24h", oldRn24hValues, start=c(1, 1, 1), count=c(10, 10, 1))
...
ncvar_put(newLatentHF24hNCDF4, "LatentHF24h", oldLatentHF24hValues, start=c(1, 1, 1), count=c(10, 10, 1))
